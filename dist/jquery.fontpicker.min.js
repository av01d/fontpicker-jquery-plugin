...
c.toggleModal("show")},hide:function(){var c=a(this).data("plugin_fontpicker");if(!c.$select)throw Error("jquery.fontpicker: Cannot hide, as I've been destroyed.");c.toggleModal("hide")},destroy:function(){var c=a(this).data("plugin_fontpicker");c.toggleModal("hide");c.$select.remove();c.$element.remove();c.$original.off("setFont");c.$original.show();c.$select=c.$element=c.$original=c.$modal=null;a(c).removeData("plugin_fontpicker")}};return k}();if("string"===typeof arguments[0]){var r=arguments[0],
x=Array.prototype.slice.call(arguments,1),t;this.each(function(){if(a.data(this,"plugin_fontpicker")&&"function"===typeof a.data(this,"plugin_fontpicker")[r])t=a.data(this,"plugin_fontpicker")[r].apply(this,x);else throw Error("jquery.fontpicker: Method "+r+" does not exist.");});return void 0!==t?t:this}return this.each(function(){a.data(this,"plugin_fontpicker")||(k&&a.extend(v,k),a.data(this,"plugin_fontpicker",new w(this,v)))})}})(jQuery);
