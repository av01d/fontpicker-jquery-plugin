var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,g,f){a instanceof String&&(a=String(a));for(var k=a.length,h=0;h<k;h++){var m=a[h];if(g.call(f,m,h,a))return{i:h,v:m}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
...
$jscomp.iteratorFromArray=function(a,g){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var f=0,k={next:function(){if(f<a.length){var h=f++;return{value:g(h,a[h]),done:!1}}k.next=function(){return{done:!0,value:void 0}};return k.next()}};k[Symbol.iterator]=function(){return k};return k};$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");
(function(a){var g={},f={arabic:"Arabic",bengali:"Bengali","chinese-hongkong":"Chinese (Hong Kong)","chinese-simplified":"Chinese (Simplified","chinese-traditional":"Chinese (Traditional)",cyrillic:"Cyrillic","cyrillic-ext":"Cyrillic Extended",devanagari:"Devanagari",greek:"Greek","greek-ext":"Greek Extended",gujarati:"Gujarati",gurmukhi:"Gurmukhi",hebrew:"Hebrew",japanese:"Japanese",kannada:"Kannada",khmer:"Khmer",korean:"Korean",latin:"Latin","latin-ext":"Latin Extended",malayalam:"Malayalam",myanmar:"Myanmar",
oriya:"Oriya",sinhala:"Sinhala",tamil:"Tamil",telugu:"Telugu",thai:"Thai",tibetan:"Tibetan",vietnamese:"Vietnamese"},k=["serif","sans-serif","display","handwriting","monospace"];a.fn.fontpicker=function(h){var m=function(a){var b=a.parentElement,c=a.getBoundingClientRect();b=b.getBoundingClientRect();c.bottom>b.bottom&&a.scrollIntoView(!1);c.top<b.top&&a.scrollIntoView()},n=function(a,b){var c=new Date,d={},e;var l=(l=/(?:^|; )jqfs=([^;]*)/.exec(document.cookie))?decodeURIComponent(l[1]):null;if(null!==
l)for(e in l=l.split("||"),l)try{var g=l[e].split("|",2);d[g[0]]=g[1]}catch(z){}if(1===arguments.length)return d[a];null===b||!1===b?delete d[a]:d[a]=b;l=[];for(e in d)l.push(e+"|"+d[e]);c.setTime(c.getTime()+31536E6);c="; expires="+c.toGMTString();document.cookie="jqfs="+encodeURIComponent(l.join("||"))+c+"; path=/"},p={ABeeZee:{category:"sans-serif",variants:"400,400i",subsets:"latin"},Abel:{category:"sans-serif",variants:"400",subsets:"latin"},"Abhaya Libre":{category:"serif",variants:"400,500,600,700,800",
...
variants:"400,400i,600,600i"}}},x=function(){function h(b,c){if(c.googleFonts&&Array.isArray(c.googleFonts)){for(var d={},e,l=0;l<c.googleFonts.length;l++)e=c.googleFonts[l],d[e]=p[e];c.googleFonts=d}else!1!==c.googleFonts&&(c.googleFonts=p);c.localFonts||(c.localFonts=[]);v[c.lang]||(c.lang="en");this.dictionary=v[c.lang];this.allFonts={google:c.googleFonts,local:c.localFonts};this.options=c;this.$original=a(b);this.setupHtml();this.bindEvents();this.fontActive=null}h.prototype={loadFont:function(b,
c){if(!g[c])switch(g[c]=!0,b){case "google":b="https://fonts.googleapis.com/css?family="+c.replace(/ /g,"+")+":"+this.options.googleFonts[c].variants+"&display=swap";this.options.debug&&console.log("Loading Google font "+c+" from "+b);a("head").append(a("<link>",{href:b,rel:"stylesheet",type:"text/css"}));break;case "local":this.options.debug&&console.log("Loading local font "+c),a("head").append("<style> @font-face { font-family:'"+c+"'; src:local('"+c+"'), url('"+this.options.localFontsUrl+c+".woff') format('woff'); } </style>")}},
showSample:function(b){a(".fp-sample",this.$element).css({fontFamily:"'"+b.data("font-family")+"'",fontStyle:b.data("font-italic")?"italic":"normal",fontWeight:b.data("font-weight")||400})},keyDown:function(b,c){function d(a){a.preventDefault();a.stopPropagation()}c=a("li.fp-active:visible",this.$results);switch(b.keyCode){case 38:d(b);$prevLi=c.prevAll(":not(.fp-divider):visible:first");0==$prevLi.length&&($prevLi=a("li:not(.fp-divider):visible:last",this.$results));$prevLi.trigger("mouseenter").trigger("click");
...
b.data("font-family"));this.showSample(b)},click:function(b,c){var d=a(c),e=this,l=d.data("font-type"),g=d.data("font-family"),f=d.data("font-italic")||!1,h=d.data("font-weight")||400,k=(b=n("favs"))?b.split(","):[];if(!this.fontActive||this.fontActive!=g)if(this.fontActive=g,a("li.fp-active",this.$results).removeClass("fp-active").find(".fp-variants,.fp-btns").remove(),d.addClass("fp-active"),b=a('<div class="fp-btns">'),c=-1!=k.indexOf(l+":"+g),b.append(a('<span class="fp-favorite'+(c?" checked":
"")+'"></span>').on("click",function(b){b.stopPropagation();b=k.indexOf(l+":"+g);a(this).is(".checked")?-1!=b&&k.splice(b,1):-1==b&&k.push(l+":"+g);a(this).toggleClass("checked");n("favs",k.join(","))}),a('<button type="button" class="fp-btn apply">').html(this.dictionary.select).on("click",function(a){a.stopPropagation();f=d.data("font-italic");h=d.data("font-weight")||400;a=g;e.options.variants&&(a+=":"+h+(f?"i":""));e.$select.css({fontFamily:g,fontStyle:f?"italic":"normal",fontWeight:h}).find("span").html(a);
e.$original.val(a).change();e.toggleModal("hide");if(e.options.nrRecents){a=n("recents");var b=d.data("font-type")+":"+g;a=a?a.split(","):[];-1==a.indexOf(b)&&a.unshift(b);a=a.slice(0,e.options.nrRecents);n("recents",a.join(","))}})),b.appendTo(d),b=this.allFonts[l][g],b=b.variants?b.variants.split(","):[],this.options.variants&&1<b.length){c=a('<div class="fp-variants">');for(var m=!1,q={},r=0;r<b.length;q={$jscomp$loop$prop$fontWeight$1:q.$jscomp$loop$prop$fontWeight$1},r++)if(/i$/.test(b[r]))m||
(m=!0);else{var p=b[r];q.$jscomp$loop$prop$fontWeight$1=+p.replace(/i$/,"");0<r&&c.append(" ");a('<span data-font-weight="'+q.$jscomp$loop$prop$fontWeight$1+'" class="fp-pill weight'+(h==q.$jscomp$loop$prop$fontWeight$1?" checked":"")+'">').html(p).on("click",function(b){return function(c){c.stopPropagation();a("span.fp-pill.weight",d).removeClass("checked");a(this).addClass("checked");d.data("font-weight",b.$jscomp$loop$prop$fontWeight$1);e.showSample(d)}}(q)).appendTo(c)}m&&(c.append(" "),a('<span class="fp-pill italic '+
(f?" checked":"")+'">').html("italic").on("click",function(b){b.stopPropagation();f=!f;a(this).toggleClass("checked");d.data("font-italic",f);e.showSample(d)}).appendTo(c));d.append(c)}},fontSpecToComponents:function(a){var b=a.split(":");a=b[0];var d=b[1]||"400";b=!1;/(\d+)i$/.test(d)?(b=!0,d=+RegExp.$1):d=+d;return{family:a,weight:d,italic:b}},applyFontToOriginalInput:function(a){var b=this.fontSpecToComponents(a);this.loadFont(p[b.family]?"google":"local",b.family);this.$select.css({fontFamily:b.family,
fontStyle:b.italic?"italic":"normal",fontWeight:b.weight}).find("span").html(a)},bindEvents:function(){var b=this;this.$results.on("keydown",function(a){b.keyDown(a,this)}).on("mouseenter","li:not(.fp-divider):visible",function(a){b.mouseEnter(a,this)}).on("click","li:not(.fp-divider):visible",function(a){b.click(a,this)}).on("dblclick","li:not(.fp-divider):visible",function(b){a("li.fp-active",this.$results).find("button.apply").trigger("click")});this.$original.on("change",function(a){b.applyFontToOriginalInput(this.value)})},
lazyLoad:function(){if(window.IntersectionObserver){var b=this,c,d=new IntersectionObserver(function(e){[].forEach.call(e,function(e){0<e.intersectionRatio&&(d.unobserve(e.target),c=a(e.target),b.loadFont(c.data("font-type"),c.data("font-family")),c.css("fontFamily","'"+c.data("font-family")+"'"))})});a("li:not(.fp-divider)",this.$results).each(function(){d.observe(this)})}},toggleModal:function(b){b||(b=this.$modal.is(":visible")?"hide":"show");if("hide"==b)a(".fp-fav",this.$results).remove(),this.$modal.css("display",
"none"),a(".fp-modal-backdrop",this.$element).remove(),a(this.options.parentElement).removeClass("fp-modal-open");else{this.fontActive=null;a(this.options.parentElement).addClass("fp-modal-open");this.$element.append(a('<div class="fp-modal-backdrop">').on("click",function(){a(".fp-close",this.$modal).trigger("click")}));this.$modal.css("display","flex");this.getFavorites();if(b=this.$original.val()){b=this.fontSpecToComponents(b);var c=a("[data-font-family='"+b.family+"']",this.$results);c.trigger("mouseenter").trigger("click");
a("span.fp-pill",c).removeClass("checked");a("span[data-font-weight='"+b.weight+"']",c).addClass("checked");b.italic&&a("span.italic",this.$results).addClass("checked");m(c[0])}else this.$results.scrollTop(0);this.options.lazyLoad&&this.lazyLoad();this.$results.focus()}},applyFilter:function(){var b=this.$lang.val(),c=this.$search.val().trim(),d=[];a(".fp-category",this.$filter).each(function(){a(this).hasClass("checked")&&d.push(a(this).data("category"))});n("lang",""===b?!1:b);n("cats",d.join(","));
for(var e in this.allFonts)for(var g in this.allFonts[e]){var f=this.allFonts[e][g],k=f.subsets?f.subsets.split(","):[],h=a("li[data-font-family='"+g+"']",this.$results);f=f.category||"other";""!=b&&-1==k.indexOf(b)||-1==d.indexOf(f)||""!=c&&-1==g.toLowerCase().indexOf(c.toLowerCase())?h.hide():h.show()}},getFilterUI:function(){var b=this,c=a('<div class="fp-search-wrap">');this.$filter=a('<div class="fp-filter">');this.$search=a("<input>",{"class":"fp-search",type:"text",placeholder:this.dictionary.search,
spellcheck:!1}).on("keyup",function(){b.applyFilter()}).appendTo(c);a('<div class="fp-clear">').html("&times;").on("click",function(){b.$search.val("").focus();b.applyFilter()}).appendTo(c);var d=['<option value="">'+this.dictionary.allLangs+"</option>"],e;for(e in f)d.push('<option value="'+e+'">'+f[e]+"</option>");this.$lang=a('<select class="fp-lang">').on("change",function(){b.applyFilter()}).html(d.join(""));this.$filter.append(a('<div class="fp-row">').append(c,this.$lang));a('<div class="hr">').appendTo(this.$filter);
c=k.slice(0);c.push("other");for(d=0;d<c.length;d++)a('<span class="fp-category fp-pill checked">').data("category",c[d]).text(c[d]).on("click",function(){a(this).toggleClass("checked");b.applyFilter()}).appendTo(this.$filter)},getFontsList:function(){function b(b,e){var f=c.allFonts[b][e],h="";if(f.category||f.variants)h=[],f.category&&h.push(f.category),c.options.variants&&f.variants&&(f=f.variants.split(",").length,1<f&&h.push(f+" "+c.dictionary.styles)),h=" <small>"+h.join(", ")+"</small>";g=
a("<li>",{"data-font-type":b,"data-font-family":e}).html(e+h);d.append(g[0])}var c=this,d=document.createDocumentFragment(),e;if(0<Object.keys(this.options.localFonts).length){var g=a('<li class="fp-divider">'+this.dictionary.localFonts+"</li>");d.append(g[0]);for(e in this.options.localFonts)b("local",e)}if(0<Object.keys(this.options.googleFonts).length)for(e in g=a('<li class="fp-divider">'+this.dictionary.googleFonts+"</li>"),d.append(g[0]),this.options.googleFonts)b("google",e);this.$results=
a("<ul>",{"class":"fp-results",tabindex:0}).append(d)},getFavorites:function(){var b=n("favs"),c=n("recents");b=b?b.split(","):[];c=this.options.nrRecents&&c?c.split(","):[];c=c.slice(0);for(var d=0;d<b.length;d++)-1==c.indexOf(b[d])&&c.push(b[d]);b=document.createDocumentFragment();for(d=0;d<c.length;d++){var e=c[d].split(":");fontType=e[0];fontFamily=e[1];if(font=this.allFonts[fontType][fontFamily])e=a("<li>",{"class":"fp-fav","data-font-type":fontType,"data-font-family":fontFamily}).html(fontFamily+
(font.category?" <small>"+font.category+"</small>":"")),b.append(e[0])}0<c.length&&(b.prepend(a('<li class="fp-fav fp-divider">'+this.dictionary.favFonts+"</li>")[0]),this.$results.prepend(b))},setupHtml:function(){var b=this,c=this.$original.val();this.$original.hide();this.$select=a('<div class="font-picker fp-select">').on("click",function(){b.toggleModal("show")}).append(a('<span tabindex="0">'+(c?c:this.dictionary.selectFont)+"</span>"));this.$original.after(this.$select);this.$element=a("<div>",
{"class":"font-picker"});this.$modal=a('<div class="fp-modal">').appendTo(this.$element);this.$modal.append(a('<div class="fp-header">').append(a('<div class="fp-icons">').append(a('<span class="fp-close">&times</span>').on("click",function(){b.toggleModal("hide")})),a("<h5>").text(this.dictionary.selectFont)));this.getFilterUI();this.$modal.append(this.$filter);this.$sample=a("<div>",{"class":"fp-sample",contenteditable:!0,spellcheck:!1,title:this.dictionary.sampleTextEditable}).html(this.dictionary.sampleText).appendTo(this.$modal);
this.getFontsList();this.$modal.append(this.$results);var d=n("lang"),e=n("cats");d&&this.$lang.val(d);e&&(e=e.split(","),a(".fp-category",this.$filter).each(function(){-1==e.indexOf(a(this).data("category"))?a(this).removeClass("checked"):a(this).addClass("checked")}));(d||e)&&b.applyFilter();c&&b.applyFontToOriginalInput(c);a(this.options.parentElement).append(this.$element)},show:function(){var b=a(this).data("plugin_fontpicker");if(!b.$select)throw Error("jquery.fontpicker: Cannot show, as I've been destroyed.");
b.toggleModal("show")},hide:function(){var b=a(this).data("plugin_fontpicker");if(!b.$select)throw Error("jquery.fontpicker: Cannot hide, as I've been destroyed.");b.toggleModal("hide")},destroy:function(){var b=a(this).data("plugin_fontpicker");if(!b.$select)throw Error("jquery.fontpicker: Cannot destroy, as I've been destroyed already.");b.toggleModal("hide");b.$select.remove();b.$element.remove();b.$original.off("setFont");b.$original.show();b.$select=b.$element=b.$original=b.$modal=null;a(b).removeData("plugin_fontpicker")}};
return h}();if("string"===typeof arguments[0]){var t=arguments[0],y=Array.prototype.slice.call(arguments,1),u;this.each(function(){if(a.data(this,"plugin_fontpicker")&&"function"===typeof a.data(this,"plugin_fontpicker")[t])u=a.data(this,"plugin_fontpicker")[t].apply(this,y);else throw Error("jquery.fontpicker: Method "+t+" does not exist.");});return void 0!==u?u:this}return this.each(function(){a.data(this,"plugin_fontpicker")||(h&&a.extend(w,h),a.data(this,"plugin_fontpicker",new x(this,w)))})}})(jQuery);
