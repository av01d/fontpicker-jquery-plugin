...
oriya:"Oriya",sinhala:"Sinhala",tamil:"Tamil",telugu:"Telugu",thai:"Thai",tibetan:"Tibetan",vietnamese:"Vietnamese"},k=["serif","sans-serif","display","handwriting","monospace"];a.fn.fontpicker=function(l){var m=function(a){var c=a.parentElement,b=a.getBoundingClientRect();c=c.getBoundingClientRect();b.bottom>c.bottom&&a.scrollIntoView(!1);b.top<c.top&&a.scrollIntoView()},n=function(a,c){var b=new Date,d={},g;var h=(h=/(?:^|; )jqfs=([^;]*)/.exec(document.cookie))?decodeURIComponent(h[1]):null;if(null!==
h)for(g in h=h.split("||"),h)try{var e=h[g].split("|",2);d[e[0]]=e[1]}catch(y){}if(1===arguments.length)return d[a];null===c||!1===c?delete d[a]:d[a]=c;h=[];for(g in d)h.push(g+"|"+d[g]);b.setTime(b.getTime()+31536E6);b="; expires="+b.toGMTString();document.cookie="jqfs="+encodeURIComponent(h.join("||"))+b+"; path=/"},p={ABeeZee:{category:"sans-serif",variants:"400,400i",subsets:"latin"},Abel:{category:"sans-serif",variants:"400",subsets:"latin"},"Abhaya Libre":{category:"serif",variants:"400,500,600,700,800",
...
v={lang:"en",variants:!0,lookahead:0,debug:!1,localFontsUrl:"/fonts/",parentElement:"body",localFonts:{Arial:{category:"sans-serif",variants:"400,400i,600,600i"},"Courier New":{category:"monospace",variants:"400,400i,600,600i"},Georgia:{category:"serif",variants:"400,400i,600,600i"},Tahoma:{category:"sans-serif",variants:"400,400i,600,600i"},"Times New Roman":{category:"serif",variants:"400,400i,600,600i"},"Trebuchet MS":{category:"sans-serif",variants:"400,400i,600,600i"},Verdana:{category:"sans-serif",
variants:"400,400i,600,600i"}}},w=function(){function l(c,b){if(b.googleFonts&&Array.isArray(b.googleFonts)){for(var d={},g,h=0;h<b.googleFonts.length;h++)g=b.googleFonts[h],d[g]=p[g];b.googleFonts=d}else!1!==b.googleFonts&&(b.googleFonts=p);b.localFonts||(b.localFonts=[]);u[b.lang]||(b.lang="en");this.dictionary=u[b.lang];this.allFonts={google:b.googleFonts,local:b.localFonts};this.options=b;this.$original=a(c);this.setupHtml();this.bindEvents();this.fontActive=null}l.prototype={loadFont:function(c,
b){if(!e[b])switch(e[b]=!0,c){case "google":c="https://fonts.googleapis.com/css?family="+b.replace(/ /g,"+")+":"+this.options.googleFonts[b].variants+"&display=swap";this.options.debug&&console.log("Loading Google font "+b+" from "+c);a("head").append(a("<link>",{href:c,rel:"stylesheet",type:"text/css"}));break;case "local":this.options.debug&&console.log("Loading local font "+b),a("head").append("<style> @font-face { font-family:'"+b+"'; src:local('"+b+"'), url('"+this.options.localFontsUrl+b+".woff') format('woff'); } </style>")}},
showSample:function(c){a(".fp-sample",this.$element).css({fontFamily:"'"+c.data("font-family")+"'",fontStyle:c.data("font-italic")?"italic":"normal",fontWeight:c.data("font-weight")||400})},keyDown:function(c,b){function d(a){a.preventDefault();a.stopPropagation()}b=a("li.fp-active:visible",this.$results);switch(c.keyCode){case 38:d(c);$prevLi=b.prevAll(":not(.fp-divider):visible:first");0==$prevLi.length&&($prevLi=a("li:not(.fp-divider):visible:last",this.$results));$prevLi.trigger("mouseenter").trigger("click");
m($prevLi[0]);break;case 40:d(c);$nextLi=b.nextAll(":not(.fp-divider):visible:first");0==$nextLi.length&&($nextLi=a("li:not(.fp-divider):visible:first",this.$results));$nextLi.trigger("mouseenter").trigger("click");m($nextLi[0]);break;case 13:d(c);a("li.fp-active",this.$results).find("button.apply").trigger("click");break;case 27:d(c),a(".fp-close",this.$modal).trigger("click")}},mouseEnter:function(c,b){c=a(b);a("li.fp-hover",this.$results).removeClass("fp-hover");c.addClass("fp-hover");this.loadFont(c.data("font-type"),
c.data("font-family"));this.showSample(c)},click:function(c,b){var d=a(b),g=this,h=d.data("font-type"),e=d.data("font-family"),f=d.data("font-italic")||!1,l=d.data("font-weight")||400;if(!this.fontActive||this.fontActive!=e)if(this.fontActive=e,a("li.fp-active",this.$results).removeClass("fp-active").find(".fp-variants,.fp-btns").remove(),d.addClass("fp-active"),c=a('<div class="fp-btns">'),b=-1!=g.favFonts.indexOf(h+":"+e),c.append(a('<span class="fp-favorite'+(b?" checked":"")+'"></span>').on("click",
function(b){b.stopPropagation();b=g.favFonts.indexOf(h+":"+e);a(this).is(".checked")?-1!=b&&g.favFonts.splice(b,1):-1==b&&g.favFonts.push(h+":"+e);a(this).toggleClass("checked");n("favs",g.favFonts.join(","))}),a('<button type="button" class="fp-btn apply">').html(this.dictionary.select).on("click",function(a){a.stopPropagation();f=d.data("font-italic");l=d.data("font-weight")||400;a=e;g.options.variants&&(a+=":"+l+(f?"i":""));g.$select.css({fontFamily:e,fontStyle:f?"italic":"normal",fontWeight:l}).find("span").html(a);
g.$original.val(a).change();g.toggleModal("hide")})),c.appendTo(d),c=this.allFonts[h][e],c=c.variants?c.variants.split(","):[],this.options.variants&&1<c.length){b=a('<div class="fp-variants">');for(var k=!1,m={},q=0;q<c.length;m={$jscomp$loop$prop$fontWeight$1:m.$jscomp$loop$prop$fontWeight$1},q++)if(/i$/.test(c[q]))k||(k=!0);else{var p=c[q];m.$jscomp$loop$prop$fontWeight$1=+p.replace(/i$/,"");0<q&&b.append(" ");a('<span data-font-weight="'+m.$jscomp$loop$prop$fontWeight$1+'" class="fp-pill weight'+
(l==m.$jscomp$loop$prop$fontWeight$1?" checked":"")+'">').html(p).on("click",function(b){return function(c){c.stopPropagation();a("span.fp-pill.weight",d).removeClass("checked");a(this).addClass("checked");d.data("font-weight",b.$jscomp$loop$prop$fontWeight$1);g.showSample(d)}}(m)).appendTo(b)}k&&(b.append(" "),a('<span class="fp-pill italic '+(f?" checked":"")+'">').html("italic").on("click",function(b){b.stopPropagation();f=!f;a(this).toggleClass("checked");d.data("font-italic",f);g.showSample(d)}).appendTo(b));
d.append(b)}},fontSpecToComponents:function(a){var b=a.split(":");a=b[0];var c=b[1]||"400";b=!1;/(\d+)i$/.test(c)?(b=!0,c=+RegExp.$1):c=+c;return{family:a,weight:c,italic:b}},applyFontToOriginalInput:function(a){var b=this.fontSpecToComponents(a);this.loadFont(p[b.family]?"google":"local",b.family);this.$select.css({fontFamily:b.family,fontStyle:b.italic?"italic":"normal",fontWeight:b.weight}).find("span").html(a)},bindEvents:function(){var c=this;this.$results.on("keydown",function(a){c.keyDown(a,
this)}).on("mouseenter","li:not(.fp-divider):visible",function(a){c.mouseEnter(a,this)}).on("click","li:not(.fp-divider):visible",function(a){c.click(a,this)}).on("dblclick","li:not(.fp-divider):visible",function(b){a("li.fp-active",this.$results).find("button.apply").trigger("click")});this.$original.on("change",function(a){c.applyFontToOriginalInput(this.value)})},scrollSpy:function(){var c=this,b=this.$results[0].getBoundingClientRect(),d=b.top,g=b.top+b.height;0<this.options.lookahead&&(g+=a("li:not(.fp-divider):visible:first",
this.$results).height()*this.options.lookahead);a("li:not(.fp-divider):visible",this.$results).each(function(){var h=this.getBoundingClientRect(),e=h.top+d-b.top;h=e+h.height;var f=a(this);h>=d&&e<=g&&(c.loadFont(f.data("font-type"),f.data("font-family")),f.css("fontFamily","'"+f.data("font-family")+"'"))})},toggleModal:function(c){var b=this;c||(c=this.$modal.is(":visible")?"hide":"show");if("hide"==c)!1!==this.options.lookahead&&clearInterval(this.lookaheadInterval),a(".fp-fav",this.$results).remove(),
this.$modal.css("display","none"),a(".fp-modal-backdrop",this.$element).remove(),a(this.options.parentElement).removeClass("fp-modal-open");else{this.fontActive=null;c=this.$original.val();a(this.options.parentElement).addClass("fp-modal-open");this.$element.append(a('<div class="fp-modal-backdrop">').on("click",function(){a(".fp-close",this.$modal).trigger("click")}));this.$modal.css("display","flex");!1!==this.options.lookahead&&(b.scrollSpy(),b.lookaheadInterval=setInterval(function(){b.scrollSpy()},
500));var d=n("favs");this.favFonts=d?d.split(","):[];this.getFavorites(this.favFonts);c?(c=b.fontSpecToComponents(c),d=a("[data-font-family='"+c.family+"']",this.$results),d.trigger("mouseenter").trigger("click"),a("span.fp-pill",d).removeClass("checked"),a("span[data-font-weight='"+c.weight+"']",d).addClass("checked"),c.italic&&a("span.italic",b.$results).addClass("checked"),m(d[0])):this.$results.scrollTop(0);this.$results.focus()}},applyFilter:function(){var c=this.$lang.val(),b=this.$search.val().trim(),
d=[];a(".fp-category",this.$filter).each(function(){a(this).hasClass("checked")&&d.push(a(this).data("category"))});n("lang",""===c?!1:c);n("cats",d.join(","));for(var g in this.allFonts)for(var e in this.allFonts[g]){var f=this.allFonts[g][e],l=f.subsets?f.subsets.split(","):[],k=a("li[data-font-family='"+e+"']",this.$results);f=f.category||"other";""!=c&&-1==l.indexOf(c)||-1==d.indexOf(f)||""!=b&&-1==e.toLowerCase().indexOf(b.toLowerCase())?k.hide():k.show()}},getFilterUI:function(){var c=this;
this.$filter=a('<div class="fp-filter">');this.$search=a("<input>",{"class":"fp-search",type:"text",placeholder:this.dictionary.search}).on("keyup",function(){c.applyFilter()});var b=['<option value="">'+this.dictionary.allLangs+"</option>"],d;for(d in f)b.push('<option value="'+d+'">'+f[d]+"</option>");this.$lang=a('<select class="fp-lang">').on("change",function(){c.applyFilter()}).html(b.join(""));this.$filter.append(a('<div class="fp-row">').append(this.$search,this.$lang));a('<div class="hr">').appendTo(this.$filter);
b=k.slice(0);b.push("other");for(d=0;d<b.length;d++)a('<span class="fp-category fp-pill checked">').data("category",b[d]).text(b[d]).on("click",function(){a(this).toggleClass("checked");c.applyFilter()}).appendTo(this.$filter)},getFontsList:function(){function c(c,e){var g=b.allFonts[c][e],h="";if(g.category||g.variants)h=[],g.category&&h.push(g.category),b.options.variants&&g.variants&&(g=g.variants.split(",").length,1<g&&h.push(g+" "+b.dictionary.styles)),h=" <small>"+h.join(", ")+"</small>";f=
a("<li>",{"data-font-type":c,"data-font-family":e}).html(e+h);d.append(f[0])}var b=this,d=document.createDocumentFragment(),e;if(0<Object.keys(this.options.localFonts).length){var f=a('<li class="fp-divider">'+this.dictionary.localFonts+"</li>");d.append(f[0]);for(e in this.options.localFonts)c("local",e)}if(0<Object.keys(this.options.googleFonts).length)for(e in f=a('<li class="fp-divider">'+this.dictionary.googleFonts+"</li>"),d.append(f[0]),this.options.googleFonts)c("google",e);this.$results=
a("<ul>",{"class":"fp-results",tabindex:0}).append(d)},getFavorites:function(c){for(var b=document.createDocumentFragment(),d=null,e=0;e<c.length;e++){var f=c[e].split(":"),l=f[0];f=f[1];var k=this.allFonts[l][f];k&&(d=a("<li>",{"class":"fp-fav","data-font-type":l,"data-font-family":f}).html(f+(k.category?" <small>"+k.category+"</small>":"")),b.append(d[0]))}null!==d&&(b.prepend(a('<li class="fp-fav fp-divider">'+this.dictionary.favFonts+"</li>")[0]),this.$results.prepend(b))},setupHtml:function(){var c=
this,b=this.$original.val();this.$original.hide();this.$select=a('<div class="font-picker fp-select">').on("click",function(){c.toggleModal("show")}).append(a('<span tabindex="0">'+(b?b:this.dictionary.selectFont)+"</span>"));this.$original.after(this.$select);this.$element=a("<div>",{"class":"font-picker"});this.$modal=a('<div class="fp-modal">').appendTo(this.$element);this.$modal.append(a('<div class="fp-header">').append(a('<div class="fp-icons">').append(a('<span class="fp-close">&times</span>').on("click",
function(){c.toggleModal("hide")})),a("<h5>").text(this.dictionary.selectFont)));this.getFilterUI();this.$modal.append(this.$filter);this.$sample=a("<div>",{"class":"fp-sample",contenteditable:!0,spellcheck:!1,title:this.dictionary.sampleTextEditable}).html(this.dictionary.sampleText).appendTo(this.$modal);this.getFontsList();this.$modal.append(this.$results);var d=n("lang"),e=n("cats");d&&this.$lang.val(d);e&&(e=e.split(","),a(".fp-category",this.$filter).each(function(){-1==e.indexOf(a(this).data("category"))?
a(this).removeClass("checked"):a(this).addClass("checked")}));(d||e)&&c.applyFilter();b&&c.applyFontToOriginalInput(b);a(this.options.parentElement).append(this.$element)},show:function(){a(this).data("plugin_fontpicker").toggleModal("show")},hide:function(){a(this).data("plugin_fontpicker").toggleModal("hide")},destroy:function(){var c=a(this).data("plugin_fontpicker");c.toggleModal("hide");c.$select.remove();c.$element.remove();c.$original.off("setFont");c.$original.show();a(c).removeData("plugin_fontpicker")}};
return l}();if("string"===typeof arguments[0]){var r=arguments[0],x=Array.prototype.slice.call(arguments,1),t;this.each(function(){if(a.data(this,"plugin_fontpicker")&&"function"===typeof a.data(this,"plugin_fontpicker")[r])t=a.data(this,"plugin_fontpicker")[r].apply(this,x);else throw Error("Method "+r+" does not exist on jQuery.fontpicker");});return void 0!==t?t:this}return this.each(function(){a.data(this,"plugin_fontpicker")||(l&&a.extend(v,l),a.data(this,"plugin_fontpicker",new w(this,v)))})}})(jQuery);
