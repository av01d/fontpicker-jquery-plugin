var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,e,f){a instanceof String&&(a=String(a));for(var k=a.length,h=0;h<k;h++){var m=a[h];if(e.call(f,m,h,a))return{i:h,v:m}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
...
$jscomp.iteratorFromArray=function(a,e){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var f=0,k={next:function(){if(f<a.length){var h=f++;return{value:e(h,a[h]),done:!1}}k.next=function(){return{done:!0,value:void 0}};return k.next()}};k[Symbol.iterator]=function(){return k};return k};$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");
...
oriya:"Oriya",sinhala:"Sinhala",tamil:"Tamil",telugu:"Telugu",thai:"Thai",tibetan:"Tibetan",vietnamese:"Vietnamese"},k=["serif","sans-serif","display","handwriting","monospace"];a.fn.fontpicker=function(h){var m=function(a){var b=a.parentElement,c=a.getBoundingClientRect();b=b.getBoundingClientRect();c.bottom>b.bottom&&a.scrollIntoView(!1);c.top<b.top&&a.scrollIntoView()},n=function(a,b){var c=new Date,d={},g;var l=(l=/(?:^|; )jqfs=([^;]*)/.exec(document.cookie))?decodeURIComponent(l[1]):null;if(null!==
l)for(g in l=l.split("||"),l)try{var e=l[g].split("|",2);d[e[0]]=e[1]}catch(z){}if(1===arguments.length)return d[a];null===b||!1===b?delete d[a]:d[a]=b;l=[];for(g in d)l.push(g+"|"+d[g]);c.setTime(c.getTime()+31536E6);c="; expires="+c.toGMTString();document.cookie="jqfs="+encodeURIComponent(l.join("||"))+c+"; path=/"},p={ABeeZee:{category:"sans-serif",variants:"400,400i",subsets:"latin"},Abel:{category:"sans-serif",variants:"400",subsets:"latin"},"Abhaya Libre":{category:"serif",variants:"400,500,600,700,800",
...
b.data("font-family"));this.showSample(b)},click:function(b,c){var d=a(c),g=this,l=d.data("font-type"),e=d.data("font-family"),f=d.data("font-italic")||!1,h=d.data("font-weight")||400,k=(b=n("favs"))?b.split(","):[];if(!this.fontActive||this.fontActive!=e)if(this.fontActive=e,a("li.fp-active",this.$results).removeClass("fp-active").find(".fp-variants,.fp-btns").remove(),d.addClass("fp-active"),b=a('<div class="fp-btns">'),c=-1!=k.indexOf(l+":"+e),b.append(a('<span class="fp-favorite'+(c?" checked":
"")+'"></span>').on("click",function(b){b.stopPropagation();b=k.indexOf(l+":"+e);a(this).is(".checked")?-1!=b&&k.splice(b,1):-1==b&&k.push(l+":"+e);a(this).toggleClass("checked");n("favs",k.join(","))}),a('<button type="button" class="fp-btn apply">').html(this.dictionary.select).on("click",function(a){a.stopPropagation();f=d.data("font-italic");h=d.data("font-weight")||400;a=e;g.options.variants&&(a+=":"+h+(f?"i":""));g.$select.css({fontFamily:e,fontStyle:f?"italic":"normal",fontWeight:h}).find("span").html(a);
g.$original.val(a).change();g.toggleModal("hide");if(g.options.nrRecents){a=(a=n("recents"))?a.split(","):[];var b=d.data("font-type")+":"+e;-1==a.indexOf(b)&&a.unshift(b);a=a.slice(0,g.options.nrRecents);n("recents",a.join(","))}})),b.appendTo(d),b=this.allFonts[l][e],b=b.variants?b.variants.split(","):[],this.options.variants&&1<b.length){c=a('<div class="fp-variants">');for(var m=!1,q={},r=0;r<b.length;q={$jscomp$loop$prop$fontWeight$1:q.$jscomp$loop$prop$fontWeight$1},r++)if(/i$/.test(b[r]))m||
(m=!0);else{var p=b[r];q.$jscomp$loop$prop$fontWeight$1=+p.replace(/i$/,"");0<r&&c.append(" ");a('<span data-font-weight="'+q.$jscomp$loop$prop$fontWeight$1+'" class="fp-pill weight'+(h==q.$jscomp$loop$prop$fontWeight$1?" checked":"")+'">').html(p).on("click",function(b){return function(c){c.stopPropagation();a("span.fp-pill.weight",d).removeClass("checked");a(this).addClass("checked");d.data("font-weight",b.$jscomp$loop$prop$fontWeight$1);g.showSample(d)}}(q)).appendTo(c)}m&&(c.append(" "),a('<span class="fp-pill italic '+
(f?" checked":"")+'">').html("italic").on("click",function(b){b.stopPropagation();f=!f;a(this).toggleClass("checked");d.data("font-italic",f);g.showSample(d)}).appendTo(c));d.append(c)}},fontSpecToComponents:function(a){var b=a.split(":");a=b[0];var d=b[1]||"400";b=!1;/(\d+)i$/.test(d)?(b=!0,d=+RegExp.$1):d=+d;return{family:a,weight:d,italic:b}},applyFontToOriginalInput:function(a){var b=this.fontSpecToComponents(a);this.loadFont(p[b.family]?"google":"local",b.family);this.$select.css({fontFamily:b.family,
...
lazyLoad:function(){if(window.IntersectionObserver){var b=this,c,d=new IntersectionObserver(function(g){[].forEach.call(g,function(g){0<g.intersectionRatio&&(d.unobserve(g.target),c=a(g.target),b.loadFont(c.data("font-type"),c.data("font-family")),c.css("fontFamily","'"+c.data("font-family")+"'"))})});a("li:not(.fp-divider)",this.$results).each(function(){d.observe(this)})}},toggleModal:function(b){b||(b=this.$modal.is(":visible")?"hide":"show");if("hide"==b)a(".fp-fav",this.$results).remove(),this.$modal.css("display",
...
for(var g in this.allFonts)for(var e in this.allFonts[g]){var f=this.allFonts[g][e],k=f.subsets?f.subsets.split(","):[],h=a("li[data-font-family='"+e+"']",this.$results);f=f.category||"other";""!=b&&-1==k.indexOf(b)||-1==d.indexOf(f)||""!=c&&-1==e.toLowerCase().indexOf(c.toLowerCase())?h.hide():h.show()}},getFilterUI:function(){var b=this,c=a('<div class="fp-search-wrap">');this.$filter=a('<div class="fp-filter">');this.$search=a("<input>",{"class":"fp-search",type:"text",placeholder:this.dictionary.search,
...
c=k.slice(0);c.push("other");for(d=0;d<c.length;d++)a('<span class="fp-category fp-pill checked">').data("category",c[d]).text(c[d]).on("click",function(){a(this).toggleClass("checked");b.applyFilter()}).appendTo(this.$filter)},getFontsList:function(){function b(b,g){var f=c.allFonts[b][g],h="";if(f.category||f.variants)h=[],f.category&&h.push(f.category),c.options.variants&&f.variants&&(f=f.variants.split(",").length,1<f&&h.push(f+" "+c.dictionary.styles)),h=" <small>"+h.join(", ")+"</small>";e=
a("<li>",{"data-font-type":b,"data-font-family":g}).html(g+h);d.append(e[0])}var c=this,d=document.createDocumentFragment(),g;if(0<Object.keys(this.options.localFonts).length){var e=a('<li class="fp-divider">'+this.dictionary.localFonts+"</li>");d.append(e[0]);for(g in this.options.localFonts)b("local",g)}if(0<Object.keys(this.options.googleFonts).length)for(g in e=a('<li class="fp-divider">'+this.dictionary.googleFonts+"</li>"),d.append(e[0]),this.options.googleFonts)b("google",g);this.$results=
a("<ul>",{"class":"fp-results",tabindex:0}).append(d)},getFavorites:function(){var b=n("favs"),c=n("recents"),d=b?b.split(","):[];c=(this.options.nrRecents&&c?c.split(","):[]).slice(0);for(b=0;b<d.length;b++)-1==c.indexOf(d[b])&&c.push(d[b]);d=document.createDocumentFragment();var f=null;for(b=0;b<c.length;b++){var e=c[b].split(":"),h=e[0];e=e[1];var k=this.allFonts[h][e];k&&(f=a("<li>",{"class":"fp-fav","data-font-type":h,"data-font-family":e}).html(e+(k.category?" <small>"+k.category+"</small>":
"")),d.append(f[0]))}null!==f&&(d.prepend(a('<li class="fp-fav fp-divider">'+this.dictionary.favFonts+"</li>")[0]),this.$results.prepend(d))},setupHtml:function(){var b=this,c=this.$original.val();this.$original.hide();this.$select=a('<div class="font-picker fp-select">').on("click",function(){b.toggleModal("show")}).append(a('<span tabindex="0">'+(c?c:this.dictionary.selectFont)+"</span>"));this.$original.after(this.$select);this.$element=a("<div>",{"class":"font-picker"});this.$modal=a('<div class="fp-modal">').appendTo(this.$element);
this.$modal.append(a('<div class="fp-header">').append(a('<div class="fp-icons">').append(a('<span class="fp-close">&times</span>').on("click",function(){b.toggleModal("hide")})),a("<h5>").text(this.dictionary.selectFont)));this.getFilterUI();this.$modal.append(this.$filter);this.$sample=a("<div>",{"class":"fp-sample",contenteditable:!0,spellcheck:!1,title:this.dictionary.sampleTextEditable}).html(this.dictionary.sampleText).appendTo(this.$modal);this.getFontsList();this.$modal.append(this.$results);
var d=n("lang"),e=n("cats");d&&this.$lang.val(d);e&&(e=e.split(","),a(".fp-category",this.$filter).each(function(){-1==e.indexOf(a(this).data("category"))?a(this).removeClass("checked"):a(this).addClass("checked")}));(d||e)&&b.applyFilter();c&&b.applyFontToOriginalInput(c);a(this.options.parentElement).append(this.$element)},show:function(){var b=a(this).data("plugin_fontpicker");if(!b.$select)throw Error("jquery.fontpicker: Cannot show, as I've been destroyed.");b.toggleModal("show")},hide:function(){var b=
a(this).data("plugin_fontpicker");if(!b.$select)throw Error("jquery.fontpicker: Cannot hide, as I've been destroyed.");b.toggleModal("hide")},destroy:function(){var b=a(this).data("plugin_fontpicker");if(!b.$select)throw Error("jquery.fontpicker: Cannot destroy, as I've been destroyed already.");b.toggleModal("hide");b.$select.remove();b.$element.remove();b.$original.off("setFont");b.$original.show();b.$select=b.$element=b.$original=b.$modal=null;a(b).removeData("plugin_fontpicker")}};return h}();
