...
[];-1==a.indexOf(b)&&a.unshift(b);a=a.slice(0,h.options.nrRecents);n("recents",a.join(","))}}));a.appendTo(d);a=this.allFonts[g][e];var m=a.variants?a.variants.split(","):[];if(this.options.variants&&1<m.length){a=b('<div class="fp-variants">');c=!1;for(var r=0;r<m.length;r++)if(/i$/.test(m[r]))c||(c=!0);else{var q=m[r],t=+q.replace(/i$/,"");0<r&&a.append(" ");b('<span data-font-weight="'+t+'" class="fp-pill weight'+(p==t?" checked":"")+'">').text(q).on("click",function(a){a.stopPropagation();-1==
m.indexOf(t+"i")?(b(".fp-pill.italic",d).removeClass("checked").css("display","none"),f=!1,d.data("font-italic",f)):b(".fp-pill.italic",d).css("display","");b("span.fp-pill.weight",d).removeClass("checked");b(this).addClass("checked");l.data("font-weight",t);h.showSample(d)}).appendTo(a)}c&&(a.append(" "),b('<span class="fp-pill italic '+(f?" checked":"")+'">').css("display",-1==m.indexOf(p+"i")?"none":"").html("italic").on("click",function(a){a.stopPropagation();f=!f;b(this).toggleClass("checked");
l.data("font-italic",f);h.showSample(d)}).appendTo(a));d.append(a)}},fontSpecToComponents:function(a){var b=a.split(":");a=b[0];var d=b[1]||"400";b=!1;/(\d+)i$/.test(d)?(b=!0,d=+RegExp.$1):d=+d;return{family:a,weight:d,italic:b}},applyFontToOriginalInput:function(a){if(""===a)this.$select.removeAttr("style").find(".fp-fontspec").html(this.dictionary.selectFont),this.$original.val("");else{var b=this.fontSpecToComponents(a);this.loadFont(!1!==this.options.googleFonts&&u[b.family]?"google":"local",
b.family);this.$select.css({fontFamily:"'"+b.family+"'",fontStyle:b.italic?"italic":"normal",fontWeight:b.weight}).find(".fp-fontspec").html(a)}},bindEvents:function(){var a=this;this.$results.on("keydown",function(b){a.keyDown(b,this)}).on("mouseenter","li:not(.fp-divider):visible",function(b){a.mouseEnter(b,this)}).on("click","li:not(.fp-divider):visible",function(b){a.click(b,this)}).on("dblclick","li:not(.fp-divider):visible",function(a){b("li.fp-active",this.$results).find("button.apply").trigger("click")});
this.$original.on("change",function(b){a.applyFontToOriginalInput(this.value)})},lazyLoad:function(){if(window.IntersectionObserver){var a=this,c,d=new IntersectionObserver(function(h){[].forEach.call(h,function(g){0<g.intersectionRatio&&(d.unobserve(g.target),c=b(g.target),a.loadFont(c.data("font-type"),c.data("font-family")),c.css("fontFamily","'"+c.data("font-family")+"'"))})});b("li:not(.fp-divider)",this.$results).each(function(){d.observe(this)})}},toggleModal:function(a){a||(a=this.$modal.is(":visible")?
"hide":"show");if("hide"==a)b(".fp-fav,.fp-variants,.fp-btns").remove(),this.$modal.css("display","none"),b(".fp-modal-backdrop",this.$element).remove(),b(this.options.parentElement).removeClass("fp-modal-open"),b("span",this.$select).focus();else{b(this.options.parentElement).addClass("fp-modal-open");this.$element.append(b('<div class="fp-modal-backdrop">').on("click",function(){b(".fp-close",this.$modal).trigger("click")}));this.$modal.css("display","flex");this.getFavorites();if(a=this.$original.val()){a=
this.fontSpecToComponents(a);var c=b("li[data-font-family='"+a.family+"']",this.$results);0<c.length&&(c.data({"font-italic":a.italic,"font-weight":a.weight}).eq(0).trigger("click"),q(c[0]))}else this.$results.scrollTop(0);this.options.lazyLoad&&this.lazyLoad();this.$results.focus()}},applyFilter:function(){var a=this.$lang.val(),c=this.$search.val().trim(),d=[];b(".fp-category",this.$filter).each(function(){b(this).hasClass("checked")&&d.push(b(this).data("category"))});n("lang",""===a?!1:a);n("cats",
d.join(","));for(var h in this.allFonts)for(var g in this.allFonts[h]){var e=this.allFonts[h][g],f=e.subsets?e.subsets.split(","):[],p=b("li[data-font-family='"+g+"']",this.$results);e=e.category||"other";""!=a&&-1==f.indexOf(a)||-1==d.indexOf(e)||""!=c&&-1==g.toLowerCase().indexOf(c.toLowerCase())?p.hide():p.show()}},getFilterUI:function(){var a=this,c=b('<div class="fp-search-wrap">');this.$filter=b('<div class="fp-filter">');this.$search=b("<input>",{"class":"fp-search",type:"text",placeholder:this.dictionary.search,
spellcheck:!1}).on("keyup",function(){a.applyFilter()}).appendTo(c);b('<div class="fp-clear">').on("click",function(){a.$search.val("").focus();a.applyFilter()}).appendTo(c);var d=['<option value="">'+this.dictionary.allLangs+"</option>"],h;for(h in l)d.push('<option value="'+h+'">'+l[h]+"</option>");this.$lang=b('<select class="fp-lang">').on("change",function(){a.applyFilter()}).html(d.join(""));this.$filter.append(b('<div class="fp-row">').append(c,this.$lang));b('<div class="hr">').appendTo(this.$filter);
c=k.slice(0);c.push("other");for(d=0;d<c.length;d++)b('<span class="fp-category fp-pill checked">').data("category",c[d]).text(c[d]).on("click",function(){b(this).toggleClass("checked");a.applyFilter()}).appendTo(this.$filter)},getFontsList:function(){function a(a,h){var e=c.allFonts[a][h],f="";if(e.category||e.variants)f=[],e.category&&f.push(e.category),c.options.variants&&e.variants&&(e=e.variants.split(",").length,1<e&&f.push(e+" "+c.dictionary.styles)),f=" <small>"+f.join(", ")+"</small>";g=
b("<li>",{"data-font-type":a,"data-font-family":h}).html(h+f);d.append(g[0])}var c=this,d=b(document.createDocumentFragment()),h;if(0<f(this.options.localFonts)){var g=b('<li class="fp-divider">'+this.dictionary.localFonts+"</li>");d.append(g[0]);for(h in this.options.localFonts)a("local",h)}if(0<f(this.options.googleFonts))for(h in g=b('<li class="fp-divider">'+this.dictionary.googleFonts+"</li>"),d.append(g[0]),this.options.googleFonts)a("google",h);this.$results=b("<ul>",{"class":"fp-results",
tabindex:0}).append(d)},getFavorites:function(){var a=n("favs"),c=n("recents");a=a?a.split(","):[];c=this.options.nrRecents&&c?c.split(","):[];c=c.slice(0);for(var d=0;d<a.length;d++)-1==c.indexOf(a[d])&&c.push(a[d]);a=b(document.createDocumentFragment());var e=null;for(d=0;d<c.length;d++){var g=c[d].split(":");fontType=g[0];fontFamily=g[1];if(font=this.allFonts[fontType][fontFamily])g=b("[data-font-family='"+fontFamily+"']",this.$results),0<g.length&&(e=g.clone().addClass("fp-fav"),a.append(e[0]))}null!==
e&&(a.prepend(b('<li class="fp-fav fp-divider">'+this.dictionary.favFonts+"</li>")[0]),this.$results.prepend(a))},setupHtml:function(){var a=this,c=this.$original.val();this.$original.hide();this.$select=b('<div class="font-picker fp-select">').on("click",function(){a.toggleModal("show")}).on("keydown",function(b){32==b.keyCode&&(b.stopPropagation(),b.preventDefault(),a.toggleModal("show"))}).append('<span class="fp-fontspec" tabindex="0">'+(c?c:this.dictionary.selectFont)+"</span>");a.options.showClear&&
a.$select.append(b('<span class="fp-clear"></span>').on("click",function(b){b.stopPropagation();a.$select.removeAttr("style").find(".fp-fontspec").html(a.dictionary.selectFont);a.$original.val("").change()}));this.$original.after(this.$select);this.$element=b("<div>",{"class":"font-picker"});this.$modal=b('<div class="fp-modal">').appendTo(this.$element);this.$modal.append(b('<div class="fp-header">').append(b('<div class="fp-icons">').append(b('<span class="fp-close">&times</span>').on("click",function(){a.toggleModal("hide")})),
b("<h5>").text(this.dictionary.selectFont)));this.getFilterUI();this.$modal.append(this.$filter);this.$sample=b("<div>",{"class":"fp-sample",contenteditable:!0,spellcheck:!1,title:this.dictionary.sampleTextEditable}).html(this.dictionary.sampleText).appendTo(this.$modal);this.getFontsList();this.$modal.append(this.$results);var d=n("lang"),e=n("cats");d&&this.$lang.val(d);e&&(e=e.split(","),b(".fp-category",this.$filter).each(function(){-1==e.indexOf(b(this).data("category"))?b(this).removeClass("checked"):
b(this).addClass("checked")}));(d||e)&&a.applyFilter();c&&a.applyFontToOriginalInput(c);b(this.options.parentElement).append(this.$element)},show:function(){var a=b(this).data("plugin_fontpicker");if(!a.$select)throw Error("jquery.fontpicker: Cannot show, as I've been destroyed.");a.toggleModal("show")},hide:function(){var a=b(this).data("plugin_fontpicker");if(!a.$select)throw Error("jquery.fontpicker: Cannot hide, as I've been destroyed.");a.toggleModal("hide")},destroy:function(){var a=b(this).data("plugin_fontpicker");
if(!a.$select)throw Error("jquery.fontpicker: Cannot destroy, as I've been destroyed already.");a.toggleModal("hide");a.$select.remove();a.$element.remove();a.$original.off("setFont");a.$original.show();a.$select=a.$element=a.$original=a.$modal=null;b(a).removeData("plugin_fontpicker")}};return m}();if("string"===typeof arguments[0]){var v=arguments[0],A=Array.prototype.slice.call(arguments,1),w;this.each(function(){if(b.data(this,"plugin_fontpicker")&&"function"===typeof b.data(this,"plugin_fontpicker")[v])w=
b.data(this,"plugin_fontpicker")[v].apply(this,A);else throw Error("jquery.fontpicker: Method "+v+" does not exist.");});return void 0!==w?w:this}return this.each(function(){b.data(this,"plugin_fontpicker")||(m&&b.extend(y,m),b.data(this,"plugin_fontpicker",new z(this,y)))})}})(jQuery);
