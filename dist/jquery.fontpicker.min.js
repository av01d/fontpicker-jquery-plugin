var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,d,f){a instanceof String&&(a=String(a));for(var h=a.length,k=0;k<h;k++){var m=a[k];if(d.call(f,m,k,a))return{i:k,v:m}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
...
(function(a){var d={},f={arabic:"Arabic",bengali:"Bengali","chinese-hongkong":"Chinese (Hong Kong)","chinese-simplified":"Chinese (Simplified","chinese-traditional":"Chinese (Traditional)",cyrillic:"Cyrillic","cyrillic-ext":"Cyrillic Extended",devanagari:"Devanagari",greek:"Greek","greek-ext":"Greek Extended",gujarati:"Gujarati",gurmukhi:"Gurmukhi",hebrew:"Hebrew",japanese:"Japanese",kannada:"Kannada",khmer:"Khmer",korean:"Korean",latin:"Latin","latin-ext":"Latin Extended",malayalam:"Malayalam",myanmar:"Myanmar",
oriya:"Oriya",sinhala:"Sinhala",tamil:"Tamil",telugu:"Telugu",thai:"Thai",tibetan:"Tibetan",vietnamese:"Vietnamese"},h=["serif","sans-serif","display","handwriting","monospace"];a.fn.fontpicker=function(k){var m=function(a){var c=a.parentElement,b=a.getBoundingClientRect();c=c.getBoundingClientRect();b.bottom>c.bottom&&a.scrollIntoView(!1);b.top<c.top&&a.scrollIntoView()},n=function(a,c){var b=new Date,e={},g;var l=(l=/(?:^|; )jqfs=([^;]*)/.exec(document.cookie))?decodeURIComponent(l[1]):null;if(null!==
l)for(g in l=l.split("||"),l)try{var d=l[g].split("|",2);e[d[0]]=d[1]}catch(y){}if(1===arguments.length)return e[a];null===c||!1===c?delete e[a]:e[a]=c;l=[];for(g in e)l.push(g+"|"+e[g]);b.setTime(b.getTime()+31536E6);b="; expires="+b.toGMTString();document.cookie="jqfs="+encodeURIComponent(l.join("||"))+b+"; path=/"},p={ABeeZee:{category:"sans-serif",variants:"400,400i",subsets:"latin"},Abel:{category:"sans-serif",variants:"400",subsets:"latin"},"Abhaya Libre":{category:"serif",variants:"400,500,600,700,800",
...
v={lang:"en",variants:!0,lazyLoad:!0,debug:!1,localFontsUrl:"/fonts/",parentElement:"body",localFonts:{Arial:{category:"sans-serif",variants:"400,400i,600,600i"},"Courier New":{category:"monospace",variants:"400,400i,600,600i"},Georgia:{category:"serif",variants:"400,400i,600,600i"},Tahoma:{category:"sans-serif",variants:"400,400i,600,600i"},"Times New Roman":{category:"serif",variants:"400,400i,600,600i"},"Trebuchet MS":{category:"sans-serif",variants:"400,400i,600,600i"},Verdana:{category:"sans-serif",
variants:"400,400i,600,600i"}}},w=function(){function k(c,b){if(b.googleFonts&&Array.isArray(b.googleFonts)){for(var e={},g,l=0;l<b.googleFonts.length;l++)g=b.googleFonts[l],e[g]=p[g];b.googleFonts=e}else!1!==b.googleFonts&&(b.googleFonts=p);b.localFonts||(b.localFonts=[]);u[b.lang]||(b.lang="en");this.dictionary=u[b.lang];this.allFonts={google:b.googleFonts,local:b.localFonts};this.options=b;this.$original=a(c);this.setupHtml();this.bindEvents();this.fontActive=null}k.prototype={loadFont:function(c,
b){if(!d[b])switch(d[b]=!0,c){case "google":c="https://fonts.googleapis.com/css?family="+b.replace(/ /g,"+")+":"+this.options.googleFonts[b].variants+"&display=swap";this.options.debug&&console.log("Loading Google font "+b+" from "+c);a("head").append(a("<link>",{href:c,rel:"stylesheet",type:"text/css"}));break;case "local":this.options.debug&&console.log("Loading local font "+b),a("head").append("<style> @font-face { font-family:'"+b+"'; src:local('"+b+"'), url('"+this.options.localFontsUrl+b+".woff') format('woff'); } </style>")}},
showSample:function(c){a(".fp-sample",this.$element).css({fontFamily:"'"+c.data("font-family")+"'",fontStyle:c.data("font-italic")?"italic":"normal",fontWeight:c.data("font-weight")||400})},keyDown:function(c,b){function e(a){a.preventDefault();a.stopPropagation()}b=a("li.fp-active:visible",this.$results);switch(c.keyCode){case 38:e(c);$prevLi=b.prevAll(":not(.fp-divider):visible:first");0==$prevLi.length&&($prevLi=a("li:not(.fp-divider):visible:last",this.$results));$prevLi.trigger("mouseenter").trigger("click");
m($prevLi[0]);break;case 40:e(c);$nextLi=b.nextAll(":not(.fp-divider):visible:first");0==$nextLi.length&&($nextLi=a("li:not(.fp-divider):visible:first",this.$results));$nextLi.trigger("mouseenter").trigger("click");m($nextLi[0]);break;case 13:e(c);a("li.fp-active",this.$results).find("button.apply").trigger("click");break;case 27:e(c),a(".fp-close",this.$modal).trigger("click")}},mouseEnter:function(c,b){c=a(b);a("li.fp-hover",this.$results).removeClass("fp-hover");c.addClass("fp-hover");this.loadFont(c.data("font-type"),
c.data("font-family"));this.showSample(c)},click:function(c,b){var e=a(b),g=this,l=e.data("font-type"),d=e.data("font-family"),f=e.data("font-italic")||!1,k=e.data("font-weight")||400;if(!this.fontActive||this.fontActive!=d)if(this.fontActive=d,a("li.fp-active",this.$results).removeClass("fp-active").find(".fp-variants,.fp-btns").remove(),e.addClass("fp-active"),c=a('<div class="fp-btns">'),b=-1!=g.favFonts.indexOf(l+":"+d),c.append(a('<span class="fp-favorite'+(b?" checked":"")+'"></span>').on("click",
function(b){b.stopPropagation();b=g.favFonts.indexOf(l+":"+d);a(this).is(".checked")?-1!=b&&g.favFonts.splice(b,1):-1==b&&g.favFonts.push(l+":"+d);a(this).toggleClass("checked");n("favs",g.favFonts.join(","))}),a('<button type="button" class="fp-btn apply">').html(this.dictionary.select).on("click",function(a){a.stopPropagation();f=e.data("font-italic");k=e.data("font-weight")||400;a=d;g.options.variants&&(a+=":"+k+(f?"i":""));g.$select.css({fontFamily:d,fontStyle:f?"italic":"normal",fontWeight:k}).find("span").html(a);
g.$original.val(a).change();g.toggleModal("hide")})),c.appendTo(e),c=this.allFonts[l][d],c=c.variants?c.variants.split(","):[],this.options.variants&&1<c.length){b=a('<div class="fp-variants">');for(var h=!1,m={},q=0;q<c.length;m={$jscomp$loop$prop$fontWeight$1:m.$jscomp$loop$prop$fontWeight$1},q++)if(/i$/.test(c[q]))h||(h=!0);else{var p=c[q];m.$jscomp$loop$prop$fontWeight$1=+p.replace(/i$/,"");0<q&&b.append(" ");a('<span data-font-weight="'+m.$jscomp$loop$prop$fontWeight$1+'" class="fp-pill weight'+
(k==m.$jscomp$loop$prop$fontWeight$1?" checked":"")+'">').html(p).on("click",function(b){return function(c){c.stopPropagation();a("span.fp-pill.weight",e).removeClass("checked");a(this).addClass("checked");e.data("font-weight",b.$jscomp$loop$prop$fontWeight$1);g.showSample(e)}}(m)).appendTo(b)}h&&(b.append(" "),a('<span class="fp-pill italic '+(f?" checked":"")+'">').html("italic").on("click",function(b){b.stopPropagation();f=!f;a(this).toggleClass("checked");e.data("font-italic",f);g.showSample(e)}).appendTo(b));
e.append(b)}},fontSpecToComponents:function(a){var b=a.split(":");a=b[0];var c=b[1]||"400";b=!1;/(\d+)i$/.test(c)?(b=!0,c=+RegExp.$1):c=+c;return{family:a,weight:c,italic:b}},applyFontToOriginalInput:function(a){var b=this.fontSpecToComponents(a);this.loadFont(p[b.family]?"google":"local",b.family);this.$select.css({fontFamily:b.family,fontStyle:b.italic?"italic":"normal",fontWeight:b.weight}).find("span").html(a)},bindEvents:function(){var c=this;this.$results.on("keydown",function(a){c.keyDown(a,
this)}).on("mouseenter","li:not(.fp-divider):visible",function(a){c.mouseEnter(a,this)}).on("click","li:not(.fp-divider):visible",function(a){c.click(a,this)}).on("dblclick","li:not(.fp-divider):visible",function(b){a("li.fp-active",this.$results).find("button.apply").trigger("click")});this.$original.on("change",function(a){c.applyFontToOriginalInput(this.value)})},lazyLoad:function(){if(window.IntersectionObserver){var c=this,b,e=new IntersectionObserver(function(g){[].forEach.call(g,function(g){0<
g.intersectionRatio&&(e.unobserve(g.target),b=a(g.target),c.loadFont(b.data("font-type"),b.data("font-family")),b.css("fontFamily","'"+b.data("font-family")+"'"))})});a("li:not(.fp-divider)",this.$results).each(function(){e.observe(this)})}},toggleModal:function(c){c||(c=this.$modal.is(":visible")?"hide":"show");if("hide"==c)a(".fp-fav",this.$results).remove(),this.$modal.css("display","none"),a(".fp-modal-backdrop",this.$element).remove(),a(this.options.parentElement).removeClass("fp-modal-open");
else{this.fontActive=null;c=this.$original.val();a(this.options.parentElement).addClass("fp-modal-open");this.$element.append(a('<div class="fp-modal-backdrop">').on("click",function(){a(".fp-close",this.$modal).trigger("click")}));this.$modal.css("display","flex");var b=n("favs");this.favFonts=b?b.split(","):[];this.getFavorites(this.favFonts);c?(c=this.fontSpecToComponents(c),b=a("[data-font-family='"+c.family+"']",this.$results),b.trigger("mouseenter").trigger("click"),a("span.fp-pill",b).removeClass("checked"),
a("span[data-font-weight='"+c.weight+"']",b).addClass("checked"),c.italic&&a("span.italic",this.$results).addClass("checked"),m(b[0])):this.$results.scrollTop(0);this.options.lazyLoad&&this.lazyLoad();this.$results.focus()}},applyFilter:function(){var c=this.$lang.val(),b=this.$search.val().trim(),e=[];a(".fp-category",this.$filter).each(function(){a(this).hasClass("checked")&&e.push(a(this).data("category"))});n("lang",""===c?!1:c);n("cats",e.join(","));for(var g in this.allFonts)for(var d in this.allFonts[g]){var f=
this.allFonts[g][d],k=f.subsets?f.subsets.split(","):[],h=a("li[data-font-family='"+d+"']",this.$results);f=f.category||"other";""!=c&&-1==k.indexOf(c)||-1==e.indexOf(f)||""!=b&&-1==d.toLowerCase().indexOf(b.toLowerCase())?h.hide():h.show()}},getFilterUI:function(){var c=this;this.$filter=a('<div class="fp-filter">');this.$search=a("<input>",{"class":"fp-search",type:"search",placeholder:this.dictionary.search,spellcheck:!1}).on("keyup",function(){c.applyFilter()});var b=['<option value="">'+this.dictionary.allLangs+
"</option>"],e;for(e in f)b.push('<option value="'+e+'">'+f[e]+"</option>");this.$lang=a('<select class="fp-lang">').on("change",function(){c.applyFilter()}).html(b.join(""));this.$filter.append(a('<div class="fp-row">').append(this.$search,this.$lang));a('<div class="hr">').appendTo(this.$filter);b=h.slice(0);b.push("other");for(e=0;e<b.length;e++)a('<span class="fp-category fp-pill checked">').data("category",b[e]).text(b[e]).on("click",function(){a(this).toggleClass("checked");c.applyFilter()}).appendTo(this.$filter)},
getFontsList:function(){function c(c,g){var f=b.allFonts[c][g],l="";if(f.category||f.variants)l=[],f.category&&l.push(f.category),b.options.variants&&f.variants&&(f=f.variants.split(",").length,1<f&&l.push(f+" "+b.dictionary.styles)),l=" <small>"+l.join(", ")+"</small>";d=a("<li>",{"data-font-type":c,"data-font-family":g}).html(g+l);e.append(d[0])}var b=this,e=document.createDocumentFragment(),g;if(0<Object.keys(this.options.localFonts).length){var d=a('<li class="fp-divider">'+this.dictionary.localFonts+
"</li>");e.append(d[0]);for(g in this.options.localFonts)c("local",g)}if(0<Object.keys(this.options.googleFonts).length)for(g in d=a('<li class="fp-divider">'+this.dictionary.googleFonts+"</li>"),e.append(d[0]),this.options.googleFonts)c("google",g);this.$results=a("<ul>",{"class":"fp-results",tabindex:0}).append(e)},getFavorites:function(c){for(var b=document.createDocumentFragment(),e=null,f=0;f<c.length;f++){var d=c[f].split(":"),k=d[0];d=d[1];var h=this.allFonts[k][d];h&&(e=a("<li>",{"class":"fp-fav",
"data-font-type":k,"data-font-family":d}).html(d+(h.category?" <small>"+h.category+"</small>":"")),b.append(e[0]))}null!==e&&(b.prepend(a('<li class="fp-fav fp-divider">'+this.dictionary.favFonts+"</li>")[0]),this.$results.prepend(b))},setupHtml:function(){var c=this,b=this.$original.val();this.$original.hide();this.$select=a('<div class="font-picker fp-select">').on("click",function(){c.toggleModal("show")}).append(a('<span tabindex="0">'+(b?b:this.dictionary.selectFont)+"</span>"));this.$original.after(this.$select);
this.$element=a("<div>",{"class":"font-picker"});this.$modal=a('<div class="fp-modal">').appendTo(this.$element);this.$modal.append(a('<div class="fp-header">').append(a('<div class="fp-icons">').append(a('<span class="fp-close">&times</span>').on("click",function(){c.toggleModal("hide")})),a("<h5>").text(this.dictionary.selectFont)));this.getFilterUI();this.$modal.append(this.$filter);this.$sample=a("<div>",{"class":"fp-sample",contenteditable:!0,spellcheck:!1,title:this.dictionary.sampleTextEditable}).html(this.dictionary.sampleText).appendTo(this.$modal);
this.getFontsList();this.$modal.append(this.$results);var e=n("lang"),d=n("cats");e&&this.$lang.val(e);d&&(d=d.split(","),a(".fp-category",this.$filter).each(function(){-1==d.indexOf(a(this).data("category"))?a(this).removeClass("checked"):a(this).addClass("checked")}));(e||d)&&c.applyFilter();b&&c.applyFontToOriginalInput(b);a(this.options.parentElement).append(this.$element)},show:function(){var c=a(this).data("plugin_fontpicker");if(!c.$select)throw Error("jquery.fontpicker: Cannot show, as I've been destroyed.");
c.toggleModal("show")},hide:function(){var c=a(this).data("plugin_fontpicker");if(!c.$select)throw Error("jquery.fontpicker: Cannot hide, as I've been destroyed.");c.toggleModal("hide")},destroy:function(){var c=a(this).data("plugin_fontpicker");if(!c.$select)throw Error("jquery.fontpicker: Cannot destroy, as I've been destroyed already.");c.toggleModal("hide");c.$select.remove();c.$element.remove();c.$original.off("setFont");c.$original.show();c.$select=c.$element=c.$original=c.$modal=null;a(c).removeData("plugin_fontpicker")}};
return k}();if("string"===typeof arguments[0]){var r=arguments[0],x=Array.prototype.slice.call(arguments,1),t;this.each(function(){if(a.data(this,"plugin_fontpicker")&&"function"===typeof a.data(this,"plugin_fontpicker")[r])t=a.data(this,"plugin_fontpicker")[r].apply(this,x);else throw Error("jquery.fontpicker: Method "+r+" does not exist.");});return void 0!==t?t:this}return this.each(function(){a.data(this,"plugin_fontpicker")||(k&&a.extend(v,k),a.data(this,"plugin_fontpicker",new w(this,v)))})}})(jQuery);
