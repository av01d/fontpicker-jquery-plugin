...
variants:"400,400i,600,600i"}}},y=function(){function k(b,c){if(c.googleFonts&&Array.isArray(c.googleFonts)){for(var d={},h,g=0;g<c.googleFonts.length;g++)h=c.googleFonts[g],d[h]=p[h];c.googleFonts=d}else!1!==c.googleFonts&&(c.googleFonts=p);c.localFonts||(c.localFonts=[]);w[c.lang]||(c.lang="en");this.dictionary=w[c.lang];this.allFonts={google:c.googleFonts,local:c.localFonts};this.options=c;this.$original=a(b);this.setupHtml();this.bindEvents()}k.prototype={loadFont:function(b,c){if(!e[c])switch(e[c]=
!0,b){case "google":b="https://fonts.googleapis.com/css?family="+c.replace(/ /g,"+")+":"+this.options.googleFonts[c].variants+"&display=swap";this.options.debug&&console.log("Loading Google font "+c+" from "+b);a("head").append(a("<link>",{href:b,rel:"stylesheet",type:"text/css"}));break;case "local":this.options.debug&&console.log("Loading local font "+c),a("head").append("<style> @font-face { font-family:'"+c+"'; src:local('"+c+"'), url('"+this.options.localFontsUrl+c+".woff') format('woff'); } </style>")}},
showSample:function(b){a(".fp-sample",this.$element).css({fontFamily:"'"+b.data("font-family")+"'",fontStyle:b.data("font-italic")?"italic":"normal",fontWeight:b.data("font-weight")||400})},keyDown:function(b,c){function d(a){a.preventDefault();a.stopPropagation()}c=a("li.fp-active:visible",this.$results);if(49<=b.keyCode&&57>=b.keyCode||97<=b.keyCode&&105>=b.keyCode)d(b),a(".fp-pill[data-font-weight="+100*(b.keyCode-(97<=b.keyCode?96:48))+"]",c).trigger("click");else switch(b.keyCode){case 73:d(b);
a(".fp-pill.italic:visible",c).trigger("click");break;case 38:d(b);$prevLi=c.prevAll(":not(.fp-divider):visible:first");0==$prevLi.length&&($prevLi=a("li:not(.fp-divider):visible:last",this.$results));$prevLi.trigger("mouseenter").trigger("click");m($prevLi[0]);break;case 40:d(b);$nextLi=c.nextAll(":not(.fp-divider):visible:first");0==$nextLi.length&&($nextLi=a("li:not(.fp-divider):visible:first",this.$results));$nextLi.trigger("mouseenter").trigger("click");m($nextLi[0]);break;case 13:d(b);a("li.fp-active",
this.$results).find("button.apply").trigger("click");break;case 27:d(b),a(".fp-close",this.$modal).trigger("click")}},mouseEnter:function(b,c){b=a(c);a("li.fp-hover",this.$results).removeClass("fp-hover");b.addClass("fp-hover");this.loadFont(b.data("font-type"),b.data("font-family"));this.showSample(b)},click:function(b,c){var d=a(c),h=this,g=d.data("font-type"),e=d.data("font-family"),f=d.data("font-italic")||!1,k=d.data("font-weight")||400,l=a("li[data-font-family='"+e+"']",this.$results),m=(b=
n("favs"))?b.split(","):[];a("li.fp-active",this.$results).removeClass("fp-active").find(".fp-variants,.fp-btns").remove();d.addClass("fp-active");b=a('<div class="fp-btns">');c=-1!=m.indexOf(g+":"+e);b.append(a('<span class="fp-favorite'+(c?" checked":"")+'"></span>').on("click",function(b){b.stopPropagation();b=m.indexOf(g+":"+e);a(this).is(".checked")?-1!=b&&m.splice(b,1):-1==b&&m.push(g+":"+e);a(this).toggleClass("checked");n("favs",m.join(","))}),a('<button type="button" class="fp-btn apply">').html(this.dictionary.select).on("click",
function(a){a.stopPropagation();f=d.data("font-italic");k=d.data("font-weight")||400;a=e;h.options.variants&&(a+=":"+k+(f?"i":""));h.$select.css({fontFamily:e,fontStyle:f?"italic":"normal",fontWeight:k}).find("span").html(a);h.$original.val(a).change();h.toggleModal("hide");if(h.options.nrRecents){a=n("recents");var b=d.data("font-type")+":"+e;a=a?a.split(","):[];-1==a.indexOf(b)&&a.unshift(b);a=a.slice(0,h.options.nrRecents);n("recents",a.join(","))}}));b.appendTo(d);b=this.allFonts[g][e];var q=
b.variants?b.variants.split(","):[];if(this.options.variants&&1<q.length){b=a('<div class="fp-variants">');c=!1;for(var r={},t=0;t<q.length;r={$jscomp$loop$prop$fontWeight$1:r.$jscomp$loop$prop$fontWeight$1},t++)if(/i$/.test(q[t]))c||(c=!0);else{var p=q[t];r.$jscomp$loop$prop$fontWeight$1=+p.replace(/i$/,"");0<t&&b.append(" ");a('<span data-font-weight="'+r.$jscomp$loop$prop$fontWeight$1+'" class="fp-pill weight'+(k==r.$jscomp$loop$prop$fontWeight$1?" checked":"")+'">').text(p).on("click",function(b){return function(c){c.stopPropagation();
-1==q.indexOf(b.$jscomp$loop$prop$fontWeight$1+"i")?(a(".fp-pill.italic",d).removeClass("checked").css("display","none"),f=!1,d.data("font-italic",f)):a(".fp-pill.italic",d).css("display","");a("span.fp-pill.weight",d).removeClass("checked");a(this).addClass("checked");l.data("font-weight",b.$jscomp$loop$prop$fontWeight$1);h.showSample(d)}}(r)).appendTo(b)}c&&(b.append(" "),a('<span class="fp-pill italic '+(f?" checked":"")+'">').css("display",-1==q.indexOf(k+"i")?"none":"").html("italic").on("click",
function(b){b.stopPropagation();f=!f;a(this).toggleClass("checked");l.data("font-italic",f);h.showSample(d)}).appendTo(b));d.append(b)}},fontSpecToComponents:function(a){var b=a.split(":");a=b[0];var d=b[1]||"400";b=!1;/(\d+)i$/.test(d)?(b=!0,d=+RegExp.$1):d=+d;return{family:a,weight:d,italic:b}},applyFontToOriginalInput:function(a){var b=this.fontSpecToComponents(a);this.loadFont(p[b.family]?"google":"local",b.family);this.$select.css({fontFamily:b.family,fontStyle:b.italic?"italic":"normal",fontWeight:b.weight}).find("span").html(a)},
bindEvents:function(){var b=this;this.$results.on("keydown",function(a){b.keyDown(a,this)}).on("mouseenter","li:not(.fp-divider):visible",function(a){b.mouseEnter(a,this)}).on("click","li:not(.fp-divider):visible",function(a){b.click(a,this)}).on("dblclick","li:not(.fp-divider):visible",function(b){a("li.fp-active",this.$results).find("button.apply").trigger("click")});this.$original.on("change",function(a){b.applyFontToOriginalInput(this.value)})},lazyLoad:function(){if(window.IntersectionObserver){var b=
this,c,d=new IntersectionObserver(function(h){[].forEach.call(h,function(g){0<g.intersectionRatio&&(d.unobserve(g.target),c=a(g.target),b.loadFont(c.data("font-type"),c.data("font-family")),c.css("fontFamily","'"+c.data("font-family")+"'"))})});a("li:not(.fp-divider)",this.$results).each(function(){d.observe(this)})}},toggleModal:function(b){b||(b=this.$modal.is(":visible")?"hide":"show");if("hide"==b)a(".fp-fav,.fp-variants,.fp-btns").remove(),this.$modal.css("display","none"),a(".fp-modal-backdrop",
this.$element).remove(),a(this.options.parentElement).removeClass("fp-modal-open"),a("span",this.$select).focus();else{a(this.options.parentElement).addClass("fp-modal-open");this.$element.append(a('<div class="fp-modal-backdrop">').on("click",function(){a(".fp-close",this.$modal).trigger("click")}));this.$modal.css("display","flex");this.getFavorites();if(b=this.$original.val()){b=this.fontSpecToComponents(b);var c=a("li[data-font-family='"+b.family+"']",this.$results);0<c.length&&(c.data({"font-italic":b.italic,
"font-weight":b.weight}).eq(0).trigger("click"),m(c[0]))}else this.$results.scrollTop(0);this.options.lazyLoad&&this.lazyLoad();this.$results.focus()}},applyFilter:function(){var b=this.$lang.val(),c=this.$search.val().trim(),d=[];a(".fp-category",this.$filter).each(function(){a(this).hasClass("checked")&&d.push(a(this).data("category"))});n("lang",""===b?!1:b);n("cats",d.join(","));for(var h in this.allFonts)for(var g in this.allFonts[h]){var e=this.allFonts[h][g],f=e.subsets?e.subsets.split(","):
[],k=a("li[data-font-family='"+g+"']",this.$results);e=e.category||"other";""!=b&&-1==f.indexOf(b)||-1==d.indexOf(e)||""!=c&&-1==g.toLowerCase().indexOf(c.toLowerCase())?k.hide():k.show()}},getFilterUI:function(){var b=this,c=a('<div class="fp-search-wrap">');this.$filter=a('<div class="fp-filter">');this.$search=a("<input>",{"class":"fp-search",type:"text",placeholder:this.dictionary.search,spellcheck:!1}).on("keyup",function(){b.applyFilter()}).appendTo(c);a('<div class="fp-clear">').html("&times;").on("click",
function(){b.$search.val("").focus();b.applyFilter()}).appendTo(c);var d=['<option value="">'+this.dictionary.allLangs+"</option>"],e;for(e in f)d.push('<option value="'+e+'">'+f[e]+"</option>");this.$lang=a('<select class="fp-lang">').on("change",function(){b.applyFilter()}).html(d.join(""));this.$filter.append(a('<div class="fp-row">').append(c,this.$lang));a('<div class="hr">').appendTo(this.$filter);c=l.slice(0);c.push("other");for(d=0;d<c.length;d++)a('<span class="fp-category fp-pill checked">').data("category",
c[d]).text(c[d]).on("click",function(){a(this).toggleClass("checked");b.applyFilter()}).appendTo(this.$filter)},getFontsList:function(){function b(b,e){var f=c.allFonts[b][e],h="";if(f.category||f.variants)h=[],f.category&&h.push(f.category),c.options.variants&&f.variants&&(f=f.variants.split(",").length,1<f&&h.push(f+" "+c.dictionary.styles)),h=" <small>"+h.join(", ")+"</small>";g=a("<li>",{"data-font-type":b,"data-font-family":e}).html(e+h);d.append(g[0])}var c=this,d=document.createDocumentFragment(),
e;if(0<Object.keys(this.options.localFonts).length){var g=a('<li class="fp-divider">'+this.dictionary.localFonts+"</li>");d.append(g[0]);for(e in this.options.localFonts)b("local",e)}if(0<Object.keys(this.options.googleFonts).length)for(e in g=a('<li class="fp-divider">'+this.dictionary.googleFonts+"</li>"),d.append(g[0]),this.options.googleFonts)b("google",e);this.$results=a("<ul>",{"class":"fp-results",tabindex:0}).append(d)},getFavorites:function(){var b=n("favs"),c=n("recents");b=b?b.split(","):
[];c=this.options.nrRecents&&c?c.split(","):[];c=c.slice(0);for(var d=0;d<b.length;d++)-1==c.indexOf(b[d])&&c.push(b[d]);b=document.createDocumentFragment();var e=null;for(d=0;d<c.length;d++){var f=c[d].split(":");fontType=f[0];fontFamily=f[1];if(font=this.allFonts[fontType][fontFamily])f=a("[data-font-family='"+fontFamily+"']",this.$results),0<f.length&&(e=f.clone().addClass("fp-fav"),b.append(e[0]))}null!==e&&(b.prepend(a('<li class="fp-fav fp-divider">'+this.dictionary.favFonts+"</li>")[0]),this.$results.prepend(b))},
setupHtml:function(){var b=this,c=this.$original.val();this.$original.hide();this.$select=a('<div class="font-picker fp-select">').on("click",function(){b.toggleModal("show")}).on("keydown",function(a){32==a.keyCode&&(a.stopPropagation(),a.preventDefault(),b.toggleModal("show"))}).append(a('<span tabindex="0">'+(c?c:this.dictionary.selectFont)+"</span>"));this.$original.after(this.$select);this.$element=a("<div>",{"class":"font-picker"});this.$modal=a('<div class="fp-modal">').appendTo(this.$element);
...
if("string"===typeof arguments[0]){var u=arguments[0],z=Array.prototype.slice.call(arguments,1),v;this.each(function(){if(a.data(this,"plugin_fontpicker")&&"function"===typeof a.data(this,"plugin_fontpicker")[u])v=a.data(this,"plugin_fontpicker")[u].apply(this,z);else throw Error("jquery.fontpicker: Method "+u+" does not exist.");});return void 0!==v?v:this}return this.each(function(){a.data(this,"plugin_fontpicker")||(k&&a.extend(x,k),a.data(this,"plugin_fontpicker",new y(this,x)))})}})(jQuery);
