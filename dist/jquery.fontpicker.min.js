...
h)for(g in h=h.split("||"),h)try{var e=h[g].split("|",2);d[e[0]]=e[1]}catch(y){}if(1===arguments.length)return d[a];null===b||!1===b?delete d[a]:d[a]=b;h=[];for(g in d)h.push(g+"|"+d[g]);c.setTime(c.getTime()+31536E6);c="; expires="+c.toGMTString();document.cookie="jqfs="+encodeURIComponent(h.join("||"))+c+"; path=/"},p={ABeeZee:{category:"sans-serif",variants:"400,400i",subsets:"latin"},Abel:{category:"sans-serif",variants:"400",subsets:"latin"},"Abhaya Libre":{category:"serif",variants:"400,500,600,700,800",
...
variants:"400,400i,600,600i"}}},w=function(){function l(b,c){if(c.googleFonts&&Array.isArray(c.googleFonts)){for(var d={},g,h=0;h<c.googleFonts.length;h++)g=c.googleFonts[h],d[g]=p[g];c.googleFonts=d}else!1!==c.googleFonts&&(c.googleFonts=p);c.localFonts||(c.localFonts=[]);u[c.lang]||(c.lang="en");this.dictionary=u[c.lang];this.allFonts={google:c.googleFonts,local:c.localFonts};this.options=c;this.$original=a(b);this.setupHtml();this.bindEvents();this.fontActive=null}l.prototype={loadFont:function(b,
...
b.data("font-family"));this.showSample(b)},click:function(b,c){var d=a(c),g=this,h=d.data("font-type"),e=d.data("font-family"),f=d.data("font-italic")||!1,l=d.data("font-weight")||400;if(!this.fontActive||this.fontActive!=e)if(this.fontActive=e,a("li.fp-active",this.$results).removeClass("fp-active").find(".fp-variants,.fp-btns").remove(),d.addClass("fp-active"),b=a('<div class="fp-btns">'),c=-1!=g.favFonts.indexOf(h+":"+e),b.append(a('<span class="fp-favorite'+(c?" checked":"")+'"></span>').on("click",
...
g.$original.val(a).change();g.toggleModal("hide")})),b.appendTo(d),b=this.allFonts[h][e],b=b.variants?b.variants.split(","):[],this.options.variants&&1<b.length){c=a('<div class="fp-variants">');for(var k=!1,m={},q=0;q<b.length;m={$jscomp$loop$prop$fontWeight$1:m.$jscomp$loop$prop$fontWeight$1},q++)if(/i$/.test(b[q]))k||(k=!0);else{var p=b[q];m.$jscomp$loop$prop$fontWeight$1=+p.replace(/i$/,"");0<q&&c.append(" ");a('<span data-font-weight="'+m.$jscomp$loop$prop$fontWeight$1+'" class="fp-pill weight'+
(l==m.$jscomp$loop$prop$fontWeight$1?" checked":"")+'">').html(p).on("click",function(b){return function(c){c.stopPropagation();a("span.fp-pill.weight",d).removeClass("checked");a(this).addClass("checked");d.data("font-weight",b.$jscomp$loop$prop$fontWeight$1);g.showSample(d)}}(m)).appendTo(c)}k&&(c.append(" "),a('<span class="fp-pill italic '+(f?" checked":"")+'">').html("italic").on("click",function(b){b.stopPropagation();f=!f;a(this).toggleClass("checked");d.data("font-italic",f);g.showSample(d)}).appendTo(c));
d.append(c)}},fontSpecToComponents:function(a){var b=a.split(":");a=b[0];var d=b[1]||"400";b=!1;/(\d+)i$/.test(d)?(b=!0,d=+RegExp.$1):d=+d;return{family:a,weight:d,italic:b}},applyFontToOriginalInput:function(a){var b=this.fontSpecToComponents(a);this.loadFont(p[b.family]?"google":"local",b.family);this.$select.css({fontFamily:b.family,fontStyle:b.italic?"italic":"normal",fontWeight:b.weight}).find("span").html(a)},bindEvents:function(){var b=this;this.$results.on("keydown",function(a){b.keyDown(a,
this)}).on("mouseenter","li:not(.fp-divider):visible",function(a){b.mouseEnter(a,this)}).on("click","li:not(.fp-divider):visible",function(a){b.click(a,this)}).on("dblclick","li:not(.fp-divider):visible",function(b){a("li.fp-active",this.$results).find("button.apply").trigger("click")});this.$original.on("change",function(a){b.applyFontToOriginalInput(this.value)})},scrollSpy:function(){var b=this,c=this.$results[0].getBoundingClientRect(),d=c.top,g=c.top+c.height;0<this.options.lookahead&&(g+=a("li:not(.fp-divider):visible:first",
this.$results).height()*this.options.lookahead);a("li:not(.fp-divider):visible",this.$results).each(function(){var h=this.getBoundingClientRect(),e=h.top+d-c.top;h=e+h.height;var f=a(this);h>=d&&e<=g&&(b.loadFont(f.data("font-type"),f.data("font-family")),f.css("fontFamily","'"+f.data("font-family")+"'"))})},toggleModal:function(b){var c=this;b||(b=this.$modal.is(":visible")?"hide":"show");if("hide"==b)!1!==this.options.lookahead&&clearInterval(this.lookaheadInterval),a(".fp-fav",this.$results).remove(),
this.$modal.css("display","none"),a(".fp-modal-backdrop",this.$element).remove(),a(this.options.parentElement).removeClass("fp-modal-open");else{this.fontActive=null;b=this.$original.val();a(this.options.parentElement).addClass("fp-modal-open");this.$element.append(a('<div class="fp-modal-backdrop">').on("click",function(){a(".fp-close",this.$modal).trigger("click")}));this.$modal.css("display","flex");!1!==this.options.lookahead&&(c.scrollSpy(),c.lookaheadInterval=setInterval(function(){c.scrollSpy()},
500));var d=n("favs");this.favFonts=d?d.split(","):[];this.getFavorites(this.favFonts);b?(b=c.fontSpecToComponents(b),d=a("[data-font-family='"+b.family+"']",this.$results),d.trigger("mouseenter").trigger("click"),a("span.fp-pill",d).removeClass("checked"),a("span[data-font-weight='"+b.weight+"']",d).addClass("checked"),b.italic&&a("span.italic",c.$results).addClass("checked"),m(d[0])):this.$results.scrollTop(0);this.$results.focus()}},applyFilter:function(){var b=this.$lang.val(),c=this.$search.val().trim(),
d=[];a(".fp-category",this.$filter).each(function(){a(this).hasClass("checked")&&d.push(a(this).data("category"))});n("lang",""===b?!1:b);n("cats",d.join(","));for(var g in this.allFonts)for(var e in this.allFonts[g]){var f=this.allFonts[g][e],l=f.subsets?f.subsets.split(","):[],k=a("li[data-font-family='"+e+"']",this.$results);f=f.category||"other";""!=b&&-1==l.indexOf(b)||-1==d.indexOf(f)||""!=c&&-1==e.toLowerCase().indexOf(c.toLowerCase())?k.hide():k.show()}},getFilterUI:function(){var b=this;
this.$filter=a('<div class="fp-filter">');this.$search=a("<input>",{"class":"fp-search",type:"text",placeholder:this.dictionary.search}).on("keyup",function(){b.applyFilter()});var c=['<option value="">'+this.dictionary.allLangs+"</option>"],d;for(d in f)c.push('<option value="'+d+'">'+f[d]+"</option>");this.$lang=a('<select class="fp-lang">').on("change",function(){b.applyFilter()}).html(c.join(""));this.$filter.append(a('<div class="fp-row">').append(this.$search,this.$lang));a('<div class="hr">').appendTo(this.$filter);
c=k.slice(0);c.push("other");for(d=0;d<c.length;d++)a('<span class="fp-category fp-pill checked">').data("category",c[d]).text(c[d]).on("click",function(){a(this).toggleClass("checked");b.applyFilter()}).appendTo(this.$filter)},getFontsList:function(){function b(b,e){var g=c.allFonts[b][e],h="";if(g.category||g.variants)h=[],g.category&&h.push(g.category),c.options.variants&&g.variants&&(g=g.variants.split(",").length,1<g&&h.push(g+" "+c.dictionary.styles)),h=" <small>"+h.join(", ")+"</small>";f=
a("<li>",{"data-font-type":b,"data-font-family":e}).html(e+h);d.append(f[0])}var c=this,d=document.createDocumentFragment(),e;if(0<Object.keys(this.options.localFonts).length){var f=a('<li class="fp-divider">'+this.dictionary.localFonts+"</li>");d.append(f[0]);for(e in this.options.localFonts)b("local",e)}if(0<Object.keys(this.options.googleFonts).length)for(e in f=a('<li class="fp-divider">'+this.dictionary.googleFonts+"</li>"),d.append(f[0]),this.options.googleFonts)b("google",e);this.$results=
a("<ul>",{"class":"fp-results",tabindex:0}).append(d)},getFavorites:function(b){for(var c=document.createDocumentFragment(),d=null,e=0;e<b.length;e++){var f=b[e].split(":"),l=f[0];f=f[1];var k=this.allFonts[l][f];k&&(d=a("<li>",{"class":"fp-fav","data-font-type":l,"data-font-family":f}).html(f+(k.category?" <small>"+k.category+"</small>":"")),c.append(d[0]))}null!==d&&(c.prepend(a('<li class="fp-fav fp-divider">'+this.dictionary.favFonts+"</li>")[0]),this.$results.prepend(c))},setupHtml:function(){var b=
this,c=this.$original.val();this.$original.hide();this.$select=a('<div class="font-picker fp-select">').on("click",function(){b.toggleModal("show")}).append(a('<span tabindex="0">'+(c?c:this.dictionary.selectFont)+"</span>"));this.$original.after(this.$select);this.$element=a("<div>",{"class":"font-picker"});this.$modal=a('<div class="fp-modal">').appendTo(this.$element);this.$modal.append(a('<div class="fp-header">').append(a('<div class="fp-icons">').append(a('<span class="fp-close">&times</span>').on("click",
...
a(this).data("plugin_fontpicker");b.toggleModal("hide");b.$select.remove();b.$element.remove();b.$original.off("setFont");b.$original.show();b.$select=b.$element=b.$original=b.$modal=null;a(b).removeData("plugin_fontpicker")}};return l}();if("string"===typeof arguments[0]){var r=arguments[0],x=Array.prototype.slice.call(arguments,1),t;this.each(function(){if(a.data(this,"plugin_fontpicker")&&"function"===typeof a.data(this,"plugin_fontpicker")[r])t=a.data(this,"plugin_fontpicker")[r].apply(this,x);
else throw Error("jquery.fontpicker: Method "+r+" does not exist.");});return void 0!==t?t:this}return this.each(function(){a.data(this,"plugin_fontpicker")||(l&&a.extend(v,l),a.data(this,"plugin_fontpicker",new w(this,v)))})}})(jQuery);
